...
TOKEN = (
    ...
    or "8923808337:AAGg7eWujyhj_pfUjc64PDc3jIyu4hFV-6c"
).strip()
try:
    OWNER_ID = int(os.environ.get("OWNER_ID", "7715382419"))
...
SUPPORT_USR = "@RIFAT_MODS_OWNER"
UPDATE_CH   = "https://t.me/BYPASS_URL_LINK"
...
REQUIRED_GROUPS = [
    {"id": -1003715566556, "link": "https://t.me/BYPASS_URL_LINK", "name": "Group 1"},
    {"id": -1003776599179, "link": "https://t.me/BYPASS_URL_LINK",     "name": "Group 2"},
]
...
def start_env_add(call: types.CallbackQuery, bot_id: str) -> None:
    ...
    bot.send_message(call.message.chat.id,
        ...
        f"{sc('Example')}: <code>BOT_TOKEN=8923808337:AAGg7eWujyhj_pfUjc64PDc3jIyu4hFV-6c</code>\n/cancel {sc('to abort')}.",
        parse_mode="HTML")
    ack(call)
